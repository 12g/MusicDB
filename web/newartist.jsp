                ...
                <div class="col-xs-4 col-xs-offset-4" >
                    ...
                    <form>
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nombre De Banda">
                            <small id="emailHelp" class="form-text text-muted">Queremos ser tu Pàgina favorita</small>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Año De Formaciòn</label>
                            <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Año Formaciòn">
                        </div>
